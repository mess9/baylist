...
export default function App() {
  ...
  fetch(`http://152.70.174.74:8080/api/auth/telegram?id=${reqQP?.id}&first_name=${reqQP?.first_name}&username=${reqQP?.username}&auth_date=${reqQP?.auth_data}&hash=${reqQP?.hash}`, {method: "POST"})
